...
${formData.message}
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="w-full max-w-4xl mx-auto p-6 rounded-lg shadow-md hover:shadow-lg transition-all relative overflow-hidden"
      style={{
        backgroundImage: 'url("/images/McDonald Świat Jeźdźca-min.jpg")',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/90 border border-gray-200 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {Object.entries(productTypeOptions).map(([value, label]) => (
                <label key={value} className="flex items-center space-x-2 p-2 rounded hover:bg-white/10 cursor-pointer">
                  <input
                    type="checkbox"
                    name="productTypes"
                    value={value}
